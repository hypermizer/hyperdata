...
select function_privs_are('public', 'create_paper_account', array['text', 'numeric'], 'authenticated', array[]::text[], 'account creation is disabled by default');
...
select function_privs_are('public', 'create_paper_account', array['text', 'numeric'], 'authenticated', array['EXECUTE'], 'activation enables owner mutations');
